...
public class LatihanArray {
    ...
    public static void main(String[] args) {
        ...
        int[] arrayAngka3 = {1,6,8,3,6,17,5,6,12,4};

        // penjumlahan antara dua buah array
        int[] arrayHasil1 = tambahArray(arrayAngka1,arrayAngka2);
        int[] arrayHasil3 = tambahArray(arrayAngka1,arrayAngka3);
        ...
        printArray(arrayHasil3, "hasil 3");
    ...
    // method untuk mencari reverse v2
